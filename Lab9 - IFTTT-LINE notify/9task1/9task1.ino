...
const char* resource = "/trigger/read_DHT11/with/key/dRELWKkl81sNi83tUqbF27";
...
void makeIFTTTRequest() {
  ...
  String jsonObject = String("{\"value1\":\"") +  String(temperature) + "\",\"value2\":\"" + String(humidity) + "\",\"value3\":\""  + "\"}";

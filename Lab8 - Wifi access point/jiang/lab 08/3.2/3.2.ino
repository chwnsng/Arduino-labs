  ...
  while (client.connected())
  {
    if (client.available())
    {
      ...
      { 
        ...
        float Humidity,Temp;
        int status = dht.read2(DHTPIN,&Temp, &Humidity, NULL);
      ...
      if (readyResponse) // отдать браузеру
      {
        ...
        if (GET == "/update")
        {
          ...
          client.print("\";");
          client.print("var tempStr = \"");
          client.print(tempStr);
          client.print("\";");
          client.print("var humidStr = \"");
        ...
        else
        {
          ...
          client.print("setInterval(function(){document.getElementById(\"tempStr\").innerHTML = window.frames[0].tempStr;}, 1000);");
          client.print("setInterval(function(){document.getElementById(\"humidStr\").innerHTML = window.frames[0].humidStr;}, 1000);");
          client.print("</script>");
          client.print("</head>");
          client.print("<body>");
          ...
          client.print("<br>");
          client.print("<span>temperature</span>");
          client.print("<br>");
          client.print("> <span id=\"tempStr\"></span>");
          client.print("<span>C</span>");
          client.print("<br>");
          client.print("<span>humidity</span>");
          client.print("<br>");
          client.print("> <span id=\"humidStr\"></span>");

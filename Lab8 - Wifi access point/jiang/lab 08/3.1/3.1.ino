    ...
    if (client.available())
    {
      ...
      if (readyResponse) // отдать браузеру
      {
        ...
        else
        {
          ...
          client.print("<br><br>");
          client.print("<form action=\"/light\">");

          if ((GET == "/") || (GET.charAt(1) == '1' && old1 == "1on" && old2 == "2off") || (GET.charAt(1) == '2' && old1 == "1off" && old2 == "2on"))
          {
            old1 = turnBulb1Off();
            old2 = turnBulb2Off();
          }
          else if ((GET.charAt(1) == '1' && old1 == "1off" && old2 == "2off") || (GET.charAt(1) == '2' && old1 == "1on" && old2 == "2on")){
            old1 = turnBulb1On();
            old2 = turnBulb2Off();
          }
          else if ((GET.charAt(1) == '1' && old1 == "1off" && old2 == "2on") || (GET.charAt(1) == '2' && old1 == "1on" && old2 == "2off")){
            old1 = turnBulb1On();
            old2 = turnBulb2On();
          }
          else if ((GET.charAt(1) == '1' && old1 == "1on" && old2 == "2on") || (GET.charAt(1) == '2' && old1 == "1off" && old2 == "2off")){
            old1 = turnBulb1Off();
            old2 = turnBulb2On();
          }
...
String turnBulb1On () {
  M5.Lcd.drawBitmap(100, 120, 100, 100, (uint16_t *)lightOn);
  client.print("<button type=\"submit\" value=\"1on\">Turn OFF2</button>");
  return "1on";
}

String turnBulb2On () {
  M5.Lcd.drawBitmap(200, 120, 100, 100, (uint16_t *)lightOn);
  client.print("<button type=\"submit\" value=\"2on\">Turn OFF2</button>");
  return "2on";
}

String turnBulb1Off () {
  M5.Lcd.drawBitmap(100, 120, 100, 100, (uint16_t *)lightOff);
  client.print("<button type=\"submit\" value=\"1off\">Turn OFF2</button>");
  return "1off";
}

String turnBulb2Off () {
  M5.Lcd.drawBitmap(200, 120, 100, 100, (uint16_t *)lightOff);
  client.print("<button type=\"submit\" value=\"2off\">Turn OFF2</button>");
  return "2off";
}
